...
def load_data(filename):
    ...
    # Mapping for the tricky columns
    months = {
    ...
    with open(filename, "r") as f:
        ...
        for row in reader:
            # You must convert each specific index to int or float
            row_evidence = [
                ...
                months[row[10]],      # Month (using our dictionary)
...
def evaluate(labels, predictions):
    ...
    return (float(sensitivity_cnt/total_sensitivity), float(specificity_cnt/total_specificity))
